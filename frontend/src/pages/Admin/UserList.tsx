...
import type { MyAPIError, UserStrict } from "../../types/main";
...
const UserList = () => {
  ...
  const users :UserStrict[]= data
  
  const gobalAPIError = error as MyAPIError 
    ...
    <div className="p-4">
      ...
      {isLoading ? (
        ...
        <Message variant="danger">
          {gobalAPIError?.data?.message|| gobalAPIError.error}
        </Message>
      ) : (
